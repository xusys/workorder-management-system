 ...
 (
     ...
     district varchar(50) default '' comment '区（县）名'
 );


insert into area value ('0000', '广东省', '总部');

insert into area value ('0100', '广州市', '总部');
...
insert into area value ('0200', '深圳市', '总部');
...
insert into area value ('0500', '佛山市', '总部');
...
insert into area value ('0600', '韶关市', '总部');
...
insert into area value ('0700', '河源市', '总部');
...
insert into area value ('0800', '梅州市', '总部');
...
insert into area value ('0900', '惠州市', '总部');
...
insert into area value ('1000', '汕尾市', '总部');
...
insert into area value ('1100', '东莞市', '总部');

insert into area value ('1200', '中山市', '总部');

insert into area value ('1300', '江门市', '总部');
...
insert into area value ('1400', '阳江市', '总部');
...
insert into area value ('1500', '湛江市', '总部');
...
insert into area value ('1600', '茂名市', '总部');
...
insert into area value ('1700', '肇庆市', '总部');
...
insert into area value ('1800', '清远市', '总部');
...
insert into area value ('2100', '云浮市', '总部');
